...
import { AllowedUserRoutesState } from './AllowedUserRoutesState'
...
const DashboardSideBar = () => {
  const allowedRoutes = useHookstate(getMutableState(AllowedUserRoutesState)).get(NO_PROXY)
...
const DashboardRoutes = () => {
  ...
  const scopeQuery = useFind(scopePath, { query: { userId: selfUser.id, paginate: false } })

  const allowedRoutes = useMutableState(AllowedUserRoutesState)

  useEffect(() => {
    allowedRoutes.set(DefaultUserRoutes)
  }, [])
